...
impl MysqlRoleRepo {
    ...
    /// # Returns
    ///
    /// A newly constructed [`MysqlRoleRepo`] object.
    ///
    pub fn new() -> MysqlRoleRepo {
        MysqlRoleRepo {
...
impl RoleRepository for MysqlRoleRepo {
...
mod tests {
    ...
    fn pgdbrolerepo_connect_to_datasource() {
        let mut role_repo = MysqlRoleRepo::new();
