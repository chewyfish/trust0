...
///
pub fn create_der_certificate(der_cert_bytes: &[u8]) -> CertificateDer<'static> {
    CertificateDer::from(der_cert_bytes.to_vec())
}
...
///
pub fn create_der_pkcs1_private_key(der_key_bytes: &[u8]) -> PrivatePkcs1KeyDer<'static> {
    PrivatePkcs1KeyDer::from(der_key_bytes.to_vec())
}
...
///
pub fn create_der_pkcs8_private_key(der_key_bytes: &[u8]) -> PrivatePkcs8KeyDer<'static> {
    PrivatePkcs8KeyDer::from(der_key_bytes.to_vec())
}
...
///
pub fn create_der_sec1_private_key(der_key_bytes: &[u8]) -> PrivateSec1KeyDer<'static> {
    PrivateSec1KeyDer::from(der_key_bytes.to_vec())
}
